...
from dgl.geometry.capi import farthest_point_sampler
from dgl.base import DGLError
import numpy as np


def farthest_point_sampler_batch(pos, npoints, start_idx=None):
...
def sample_uniform_points_batch(amount,size):
    '''changed to box instead of sphere'''
    uniform_points = np.random.uniform(-1, 1, size=size)
